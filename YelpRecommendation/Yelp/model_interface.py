...
def predict_best_restraunt(geoloc = 'PA'):
    data = get_pkl("/home/prerit/Yelp/YelpRecommendation/Yelp/data.pkl")
    classifier = get_pkl("/home/prerit/Yelp/YelpRecommendation/Yelp/model.pkl")
    cities = get_pkl("/home/prerit/Yelp/YelpRecommendation/Yelp/cities.pkl")
    business_ids = get_pkl("/home/prerit/Yelp/YelpRecommendation/Yelp/business_ids.pkl")
    ...
    outputFile = plot_on_map(list(np.array(subset_business.iloc[:250,1])),list(np.array(subset_business.iloc[:250,2])),state[geoloc])
    return outputFile
